...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.1.1-8B5CF6.svg?style=for-the-badge" alt="Version 1.1.1" />
...
| :---------------------------------- | :------------ | :-------------------------------------------------------------------------------------------- |
| **`AnyDownloader Setup 1.1.1.exe`** | **Installer** | Installs AnyDownloader, creates Desktop & Start Menu shortcuts, and supports auto-updates.    |
| **`AnyDownloader 1.1.1.exe`**       | **Portable**  | Single standalone `.exe` — run immediately without installation from any folder or USB drive. |
...
- `release/AnyDownloader Setup 1.1.1.exe`
- `release/AnyDownloader 1.1.1.exe`
